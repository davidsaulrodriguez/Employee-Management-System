...
1. Fork the project (```https://github.com/davidsaulrodriguez/employee-management-system```)
2. Clone it on your machine (```git clone https://github.com/yourUsername/employee-management-system.git```)
3. Add the upstream remote (```git remote add upstream https://github.com/davidsaulrodriguez/employee-management-system.git```)
